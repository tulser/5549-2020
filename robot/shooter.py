...
class Shooter:
    ...
    __motors = SpeedControllerGroup_M(WPI_TalonSRX(4), WPI_TalonSRX(5), WPI_TalonSRX(6), WPI_TalonSRX(7))
    ...
    def shootAuto(cls, force=False):
        ...
        cls.__motors.set(math.sqrt(-9.81*math.pow(dist, 2)/(TARGETHEIGHT+TARGETHEIGHTBIAS-dist)), WPI_TalonSRX.ControlMode.Velocity)
        return
